...
function getUpcomingMatches(team,season,upcomingdivider){
    ...
    return fetch(`https://cipher-virid.vercel.app/api/proxy2?endpoint=&participantId=${team}&participantType=TEAM&championshipId=c9f295b8-f68d-492b-bc38-75628dd91103`,{
        method: 'GET',
        headers:{
