...
export default async function handler(req, res) {
  const { teamId, champID } = req.query; 
  const apiUrl = `https://api.faceit.com/championships/v1/matches?participantId=${teamId}&participantType=TEAM&championshipId=${champID}&limit=20`
